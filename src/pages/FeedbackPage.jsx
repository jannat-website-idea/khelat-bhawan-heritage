  ...
  return (
    <main className="pt-32 pb-24 bg-background min-h-screen">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        {/* Live Google Reviews Summary Card */}
        <section className="mb-16 p-8 md:p-10 rounded-sm bg-gradient-to-br from-card via-card/95 to-secondary border border-border shadow-md relative overflow-hidden">
        ...
        {/* 4 Best Featured Google Reviews Grid */}
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {rev.items.map((item) => (
              ...
              >
                <div className="absolute top-0 right-0 px-3 py-1 bg-accent/10 border-b border-l border-accent/20 text-[10px] tracking-wider uppercase text-accent font-semibold flex items-center gap-1.5">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1 mb-3">
                    ...
                    <span className="text-[11px] font-semibold text-accent ml-2 uppercase tracking-wider">
                      {item.category}
                    </span>
                  </div>
                ...
                <div className="pt-4 border-t border-border flex items-center justify-between">
                  ...
                  <span className="text-xs text-accent font-body font-semibold group-hover:translate-x-1 transition-transform inline-flex items-center gap-1">
                    {isBn ? 'গুগলে দেখুন' : 'View on Google'} →
                  </span>
                </div>
              </a>
            ))}
        ...
        <section className="p-8 md:p-12 rounded-sm bg-card border border-border shadow-lg">
