...
export default function HeritageMilestones({ lang, milestones, onExplore, onOpenImage, eyebrow, subtitle }) {
  ...
  return (
    <section className="heritage-archive" aria-labelledby="archive-heading">
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div className="heritage-archive__spread">
          {milestones.map((item, index) => (
            <article className={`archive-entry archive-entry--${index + 1}`} key={item.year}>
        ...
        <div className="heritage-archive__footer" data-reveal>
          <span>{bn ? 'ঐতিহ্য ও উত্তরাধিকার' : 'Heritage & legacy'}</span>
          <button onClick={onExplore}>
            {bn ? 'সম্পূর্ণ ঐতিহ্যের সময়রেখা' : 'View full heritage timeline'}
