// Data-driven Khelat Bhawan Photography and Film Archives
// Supports dynamic additions, deletions, reordering (1, 5, 20, 50, 100+ items)
...
export const photographyGalleryData = [
  ...
  },
  {
    ...
    desc: {
      en: "Intricate architectural plaster reliefs and Corinthian fluted capitals showcasing 19th-century Bengali-European masonry.",
      bn: "ঊনবিংশ শতকের সূক্ষ্ম প্লাস্টার কারুকাজ ও করিন্থিয়ান শৈলীর স্তম্ভ স্থাপত্য।"
    },
  ...
  },
  {
    ...
    verticalWord: "CELEBRATIONS",
    desc: {
      en: "A continuous living monument continuing into the 21st century as Kolkata's foremost heritage estate.",
      bn: "উত্তর কলকাতার বুকে আজও সগৌরবে মাথা উঁচু করে দাঁড়িয়ে থাকা জীবন্ত ঐতিহ্যময় প্রাসাদ।"
    },
...
export const filmsGalleryData = [
  {
    ...
    category: {
      en: "HERITAGE FILM",
      bn: "ঐতিহাসিক প্রামাণ্যচিত্র"
    },
    verticalWord: "HERITAGE FILM",
    duration: "04:32",
    year: "2024",
    desc: {
      en: "High-definition cinematic walkthrough exploring the Thakur Dalan, courtyards, marble galleries, and noble heritage halls.",
      bn: "ঠাকুর দালান, মার্বেল অলিন্দ এবং রাজকীয় দরবার হলের উচ্চমানের ভিডিও পরিভ্রমণ।"
    },
  ...
  },
  {
    ...
    verticalWord: "DOCUMENTARY",
    duration: "05:15",
    year: "2023",
    desc: {
      en: "An intimate cinematic chronicle tracing 170+ years of family stewardship, musical patronage, and continuous ritual devotion.",
      bn: "১৭০+ বছরের পারিবারিক অভিভাবকত্ব, সঙ্গীত পৃষ্ঠপোষকতা ও দেবসেবার ইতিহাস।"
    },
    src: "/Videos/hero-palace-film.mp4",
    poster: "/images/khelat-bhawan-night-courtyard.jpg",
    photographer: "Bengal Heritage Cine Archive"
  },
  {
    id: "film-03",
    title: {
    ...
    year: "2024",
    desc: {
      en: "Capturing the architectural geometry, sunlight, and sacred ambience of the century-old courtyard.",
      bn: "শতবর্ষ প্রাচীন প্রাঙ্গণের স্থাপত্য জ্যামিতি, রোদের খেলা ও আধ্যাত্মিক পরিবেশের চিত্রায়ন।"
    },
    src: "/Videos/hero-courtyard.mp4",
    poster: "/images/SDP_0310.jpg",
    photographer: "Khelat Bhawan Visuals"
  },
  {
    id: "film-04",
    title: {
    ...
    verticalWord: "CINEMATIC",
    duration: "03:10",
    year: "2023",
    desc: {
      en: "Gliding through the grand fluted columns and antique Belgian chandeliers of the upper gallery.",
      bn: "উপরের গ্যালারির গ্র্যান্ড থাম এবং এন্টিক বেলজিয়ান ঝাড়বাতির সিনেমাটিক দৃশ্য।"
    },
    src: "/Videos/hero-colonnade.mp4",
    poster: "/images/khelat-bhawan-colonnade-corridor.jpg",
    photographer: "Architectural Cine Unit"
  },
  {
    id: "film-05",
    title: {
    ...
    year: "2024",
    desc: {
      en: "A smooth visual descent along the monumental Italian marble staircase and checkerboard entrance.",
      bn: "মনোরম ইতালীয় মার্বেল সিঁড়ি এবং দাবা-প্যাটার্নের প্রবেশদ্বারের দৃষ্টিনন্দন রূপ।"
    },
    src: "/Videos/hero-staircase.mp4",
    poster: "/images/SDP_0291.jpg",
    photographer: "Heritage Cine Team"
  },
  {
    id: "film-06",
    title: {
    ...
    photographer: "Craft Cine Studio"
  }
];
...
export const galleryData = [
  ...photographyGalleryData.map(p => ({
    id: p.id,
    type: "image",
    category: p.category.en.toLowerCase(),
    title: p.title.en,
    desc: p.desc.en,
    src: p.src,
